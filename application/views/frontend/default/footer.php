                ...
                <div class="row">
                    <div class="col-md-6">
                        <p class="copyright-text">
                            <a href=""><img src="<?php echo base_url().'uploads/system/Cheems.jpg'; ?>" alt="" class="d-inline-block" width="110"></a>
                    ...
                    <div class="col-md-6">
                        <ul class="nav justify-content-md-end footer-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url('home/about_us'); ?>">Liên hệ</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url('home/privacy_policy'); ?>">Chính sách bảo mật</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url('home/terms_and_condition'); ?>">Điều khoản & Điều kiện</a>
                            </li>
                            <li class="nav-item">
