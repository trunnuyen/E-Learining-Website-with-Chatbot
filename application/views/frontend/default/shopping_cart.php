        ...
        <div class="row" id="cart_items_details">
            <div class="col-lg-9">
                ...
                <div class="in-cart-box">
                    <div class="title"><?php echo "Bạn có " . sizeof($this->session->userdata('cart_items')) . ' ' . "khóa học trong giỏ hàng"; ?></div>
                    <div class="">
            ...
            <div class="col-lg-3">
                <div class="cart-sidebar">
                    ...
                    <button type="button" class="btn btn-primary btn-block checkout-btn" onclick="handleCheckOut()">Thanh toán</button>
                </div>
            </div>
        </div>
    </div>
            ...
            success: function(response) {
                if (!response) {
                    window.location.replace("<?php echo site_url('login'); ?>");
                        ...
                        $.ajax({
                            url: '<?php echo site_url('home/payment_success/' . $user_details['id'] . '/' . $amount_to_pay); ?>'
                        }).done(function() {
