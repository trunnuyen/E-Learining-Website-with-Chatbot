...
<div class="dropdown course-list-dropdown corner-triangle top-right">
    <div class="list-wrapper">
                            ...
                            <div class="item-details">
                                <a href="">
                                    ...
                                    <div class="instructor-name">
                                        <?php 'Đăng bởi:'.' '.$instructor_details['first_name'].' '.$instructor_details['last_name']; ?>
                                    </div>
        ...
        <div class="dropdown-footer">
            <a href = "<?php echo site_url('home/my_wishlist'); ?>">Xem Wishlist</a>
        </div>
    </div>
    <div class="empty-box text-center d-none">
        <p>Bạn chưa thêm khóa học nào vào wishlist</p>
        <a href="">Xem các khóa học</a>
    </div>
</div>
