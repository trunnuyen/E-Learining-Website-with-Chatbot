        ...
        <div class="row">
            <div class="col">
                ...
                <ul>
                  ...
                  <li class="active"><a href="<?php echo site_url('home/my_wishlist'); ?>">Wishlist</a></li>
                ...
                <div class="my-course-search-bar">
                    <form action="">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Tìm khóa học" onkeyup="getMyWishListsBySearchString(this.value)">
