        ...
        <div class="row">
            <div class="col">
                ...
                <h1 class="category-name">
                    Tạo tài khoản ngay để tham gia với chúng tôi
                </h1>
            </div>
        </div>
    </div>
              ...
              <div class="user-dashboard-box mt-3">
                  ...
                  <div class="user-dashboard-content w-100 register-form">
                      <div class="content-title-box">
                          ...
                          <div class="subtitle">Đăng ký để tham gia các khóa học.</div>
                      </div>
                      <form action="<?php echo site_url('login/register'); ?>" method="post">
                          ...
                          <div class="account-have text-center">
                              Bạn đã có tài khoản? <a href="javascript::" onclick="toggoleForm('login')">Đăng nhập</a>
                          </div>
                      </form>
                  </div>
