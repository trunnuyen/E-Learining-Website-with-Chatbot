                    ...
                    <div class="course-box">
                        ...
                        <div class="row" style="padding: 5px;">
                            <div class="col-md-12" style="margin-bottom: 5px;">
                                <a href="<?php echo site_url('home/course/'.slugify($course_details['title']).'/'.$my_course['id']); ?>" class="btn btn-block">Chi tiết</a>
                            </div>
                            <div class="col-md-12" style="margin-bottom: 5px;">
                                 <a href="<?php echo site_url('home/edit_course/'.$my_course['id']); ?>" class="btn btn-block">Cập nhật khóa học</a>
                            </div>
                        </div>
                    </div>
            </div>
