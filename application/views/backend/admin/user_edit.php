...
<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="dripicons-user-group"></i> Cập nhật thông tin </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title mb-3">Cập nhật thông tin người dùng</h4>
                        ...
                        <div class="tab-content b-0 mb-0">
                                                    ...
                                                    <div class="flex-grow-1 mt-1 pl-3">
                                                        <div class="input-group">
                                                            <div class="custom-file">
                                                                ...
                                                                <label class="custom-file-label ellipsis" for="user_image">Thay ảnh đại diện</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <ul class="list-inline mb-0 wizard">
                                <li class="previous list-inline-item">
                                    <a href="javascript::" class="btn btn-info">Trước</a>
                                </li>
                                <li class="next list-inline-item float-right">
                                    <a href="javascript::" class="btn btn-info">Tiếp</a>
                                </li>
                            </ul>
