...
<div class="row">
  <div class="col-12">
    <div class="page-title-box ">
      <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> Cập nhật danh mục</h4>
    </div>
  </div>
</div>
...
<div class="row justify-content-md-center">
  <div class="col-xl-6">
    <div class="card">
      <div class="card-body">
        <div class="col-lg-12">
          <h4 class="mb-3 header-title">Cập nhật danh mục</h4>
          ...
          <form class="required-form" action="<?php echo site_url('admin/categories/edit/' . $category_id); ?>" method="post" enctype="multipart/form-data">
            ...
            <button type="button" class="btn btn-primary" onclick="checkRequiredFields()">Cập nhật</button>
          </form>
        </div>
      </div> <!-- end card body-->
    </div> <!-- end card -->
