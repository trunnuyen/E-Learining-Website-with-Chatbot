...
<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="dripicons-network-3"></i> Đăng ký học viên</h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
            ...
            <div class="card-body">
                <div class="col-lg-12">
                    ...
                    <form class="required-form" action="<?php echo site_url('admin/enrol_student/enrol'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="course_id">Khóa học<span class="required">*</span> </label>
                        ...
                        <button type="button" class="btn btn-primary" onclick="checkRequiredFields()">Đăng ký học viên</button>
                    </form>
                </div>
            </div> <!-- end card body-->
        </div> <!-- end card -->
