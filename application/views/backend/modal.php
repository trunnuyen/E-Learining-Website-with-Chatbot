        ...
        <div class="modal-content">
            <div class="modal-body p-4">
                <div class="text-center">
                    ...
                    <h4 class="mt-2">Xác nhận thay đổi?</h4>
                
                    <button type="button" class="btn btn-info my-2" data-dismiss="modal">Trở về</button>
                    <a href="#" id="update_link" class="btn btn-danger my-2">Xác nhận</a>
                </div>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
